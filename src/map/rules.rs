...
pub fn build_props_layer(
    ...
    terrain_model_builder.create_model(rock_prop.clone(), vec![
        SpawnableAsset::new("rock_1").with_components_spawner(insert_blocking)
    ]);
    terrain_model_builder.create_model(rock_prop.clone(), vec![
        SpawnableAsset::new("rock_2").with_components_spawner(insert_blocking)
    ]);
    terrain_model_builder.create_model(rock_prop.clone(), vec![
        SpawnableAsset::new("rock_3").with_components_spawner(insert_blocking)
    ]);
    terrain_model_builder.create_model(rock_prop.clone(), vec![
        SpawnableAsset::new("rock_4").with_components_spawner(insert_blocking)
    ]);
