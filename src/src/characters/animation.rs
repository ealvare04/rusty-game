...
// Component that hols animation configuration
// Knows what animation we want to play and the facing
#[derive(Component)]
...
// tracks if we are moving or jumping
...
// Stores first and last frame indices for a specific animation sequence
impl AnimationClip {
    ...
    // returns where the animation begins
...
// Three branches
// 1. Animation changed (started/stopping movement or jumping) - reset to frame 0 and update the time duration for the new animation.
