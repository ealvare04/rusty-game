...
impl SpawnableAsset {
    ...
    /// Attach a custom components spawner callback (e.g., to add collision)
        ...
        for asset_def in assets {
            ...
            models_assets.add(
                ...
                ModelAsset {
                    ...
                    grid_offset,
                    // Ensure the spawned sprite sits exactly centered on the tile cell
                    world_offset: offset + Vec3::new(0.0, 0.0, 0.0),
